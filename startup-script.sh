...
CRAWLER_ARGS="--config config/websites.csv --depth 3 --concurrent 2 --no-save-html --no-pagination"
echo "執行指令: $PYTHON_CMD $PYTHON_SCRIPT $CRAWLER_ARGS" >> $LOG_FILE

# 保持 GCLOUD_PATH，這有助於 nohup 環境找到 gcloud
